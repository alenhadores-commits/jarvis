...
print()
print("=" * 72)
print("IA ROUTER - TESTE DOS MODELOS CORRIGIDOS")
print("=" * 72)
...
for cfg in PROVIDERS:
    ...
    if not provider_available(cfg):
        ...
        resultados.append((cfg.name, "INDISPONIVEL", 0.0))
        continue
...
print()
print(f"NOVOS APROVADOS: {len(aprovados)}")
print(f"AINDA FALHARAM : {len(falharam)}")
